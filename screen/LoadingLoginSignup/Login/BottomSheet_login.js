...
const BottomSheet_login = props => {
  ...
  const [nameDoubleCheck, setNameDoubleCheck] = useState(
    'ruprupruprupruprupruprurprup',
  );
  ...
  const Login = () => {
    ...
    return (
      ...
      <>
        ...
        <View>
          <TouchableOpacity onPress={signInWithKakao} style={styles.kakaoLogin}>
            <View style={styles.twentyPercent}>
              <Image
                style={styles.kakaoSymbolImage}
                source={require('../../../imageResource/jobDaHan/kakao_login_symbol.png')}
              />
            </View>
        ...
        <TouchableOpacity
          onPress={() => {
            setModalVisible(false), navigation.navigate('FindId');
          }}>
          <Text style={styles.idPage}>아이디를 잊으셨나요?</Text>
        </TouchableOpacity>
        <TouchableOpacity
          onPress={() => {
            setModalVisible(false), navigation.navigate('FindPassword');
          }}>
  ...
  const SignUp = () => {
    ...
    return (
      //SignUp 아이콘 클릭시 띄울 화면
      <>
        <ScrollView showsVerticalScrollIndicator={false}>
          <View style={{flexDirection: 'row'}}>
            <Image style={styles.redStar} source={redStar} />
            <TextInput
          ...
          <View style={styles.rowDirection}>
              ...
              <TouchableOpacity
                ...
                onPress={() => {
                  ...
                  navigation.navigate('SearchUniversity', {
                    page: 'BottomSheet_login',
                  });
                  setModalVisible(false);
                }}>
                <Image
                  style={styles.imageStyle}
                  source={require('../../../imageResource/jobDaHan/search.png')}
                />
            ...
            <View style={{flexDirection: 'row'}}>
              <TouchableOpacity
                ...
                <Image
                  style={styles.imageStyle}
                  source={require('../../../imageResource/jobDaHan/triangle.png')}
                />
  ...
  const validation_nickName = name => {
    //닉네임 유효성 검사
  ...
  const panResponders_login = useRef(
    PanResponder.create({
              ...
              style={[
                {
                  ...
                  transform: [{translateY: translateY_login}],
                },
              ]}
              {...panResponders_login.panHandlers}>
              <View style={{padding: 3}} />
              <Image
                style={{width: 100, height: 3.5, borderRadius: 50}}
                source={require('../../../imageResource/jobDaHan/modalBar.png')}
              />
              <View style={styles.iconDirection}>
                <View style={{flex: 1}} />
                <TouchableOpacity
                  onPress={() => {
                    setSignUpSelectedTab(false), setLoginSelectedTab(true);
                  }}
                  style={styles.iconLocation}>
                  <Image
                    source={require('../../../imageResource/icon/ic_login.png')}
                  />
                </TouchableOpacity>
                <TouchableOpacity
                  onPress={() => {
                    setLoginSelectedTab(false), setSignUpSelectedTab(true);
                  }}
                  style={styles.iconLocation}>
                  <Image
                    source={require('../../../imageResource/icon/ic_join.png')}
                  />
                </TouchableOpacity>
                <View style={{flex: 1}} />
              </View>
